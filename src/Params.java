...
public class Params {
  ...
  public final static int NURSES = 5;
  
  //the number of orderlies in the emergency department
  public final static int ORDERLIES = 4;
  
  //the number of orderlies required to transfer a patient
  public final static int TRANSFER_ORDERLIES = 2;
  ...
  public final static int TRANSFER_TIME = 2000;
  ...
  public final static int MAX_ARRIVE_INTERVAL = 500;
